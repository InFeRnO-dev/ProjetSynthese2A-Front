    ...
    return isAuthorized && accessRights ?(
        <>
            ...
            <div className="container">
                ...
                {props.location.state.piece.fournisseur !== null &&
                ...
                {props.location.state.piece.prix_vente !== 0 &&
                    <div className="row mt-2">
                ...
                {props.location.state.piece.prix_achat !== 0 &&
                    <div className="row mt-2">
                ...
                {props.location.state.piece.gamme !== null &&
                    <div className="row mt-2">
                        <div className="col offset-2">
                            <Link to={{pathname: `/atelier/piece/gamme/${props.location.state.piece.gamme}`, state: {gamme: gamme}}}><button className="btn btn-primary">Voir la gamme associée a cette pièce</button></Link>
                        </div>
